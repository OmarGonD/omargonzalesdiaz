...
La habilidad de extraer data de un sitio web es invaluable para cualquier que se quiere dedicar al #datascience. En este post aprenderemos a extraer data con python y la librería BeautifulSoup.
...
Esta es la app elaborada en django que finalmente se trabajo, con la información que se extrajo utilizando este tutorial:
...
En otros tutoriales les enseñaré como crear esta app en Django, y subirla a Heroku. También como hacer gráficos con la librería D3, una de las librerías gráficas más potentes, utilizada por medios como The Whasingtong Post para elaborar gráficos dinámicos, entre otros. 
